...
namespace IndiaTalks.API.Repositories
{
    public class SQLWalkRepository : IWalkRepository
    {
        ...
        public SQLWalkRepository(IndiaWalkAuthDbContext dBContext)
        {
            this.dbContext = dBContext;
        }

        public IndiaWalkAuthDbContext DBContext { get; }
        ...
        {
         // return await dbContext.Walks.Include("Difficulty").Include("Region").ToListAsync(); //List of the walks back
